                    ...
                    <?php foreach ($users as $index => $user): ?>
                        <tr>
                            ...
                            <td class="p-4 border-b border-blue-gray-50 w-48">
                                <?php if (User::hasPermission('users', 'edit')): ?>

                                    <a href="<?= "/users/edit?id={$user['id']}" ?>" class="inline-block mx-2 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900">
                                        Edit
                                    </a>
                                <?php endif ?>
                                <?php if (User::hasPermission('users', 'delete')): ?>
...
<form action="/users/delete" method="post" class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 overflow-y-auto opacity-0 pointer-events-none" id="dialogue">
